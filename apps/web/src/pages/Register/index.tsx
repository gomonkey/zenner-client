        ...
        <div className="col-span-1 lg:col-span-3 flex flex-col justify-center items-center p-8 lg:p-12 bg-background relative z-10">
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="space-y-2 text-center lg:text-left">
              <h1 className="text-3xl font-bold font-outfit tracking-tight">{t('auth.signup')}</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full mt-2 font-semibold h-11" size="lg" tabIndex={5}>
                {t('auth.signup')}
              </Button>
            </form>
